...
urlpatterns = [
    ...
    path("members/", views.MembersView.as_view(), name="member_views"),
    ...
    path("movie/delete/<int:id>/", views.MovieDeleteView.as_view(), name="delete_movie"),
    path("member/update/<int:id>/", views.MemberUpdateView.as_view(), name="update_movie"),
    path("member/delete/<int:id>/", views.MemberDeleteView.as_view(), name="delete_member"),
    path("member/create/", views.MemberCreateView.as_view()),
    path("actors/", views.ActorView.as_view(), name="actors_view"),
    path("actor/create/", views.ActorCreateView.as_view()),
    path("actor/delete/<int:id>/", views.ActorDeleteView.as_view(), name='delete_actor'),
